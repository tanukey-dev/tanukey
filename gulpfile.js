...
gulp.task("copy:frontend:fonts", () =>
	gulp
		.src("./packages/frontend/node_modules/three/examples/fonts/**/*")
		.pipe(gulp.dest("./built/_frontend_dist_/fonts/")),
);

gulp.task("copy:frontend:tabler-icons", () =>
	gulp
		.src("./packages/frontend/node_modules/@tabler/icons-webfont/**/*")
		.pipe(gulp.dest("./built/_frontend_dist_/tabler-icons/")),
);
