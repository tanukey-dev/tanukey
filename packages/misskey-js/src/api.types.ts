...
export type Endpoints = {
	...
	'admin/full-index-stats': { req: TODO; res: TODO; };
	...
	'notes/followed-channel-timeline': { req: { limit?: number; sinceId?: Note['id']; untilId?: Note['id']; sinceDate?: number; untilDate?: number; }; res: Note[]; };
