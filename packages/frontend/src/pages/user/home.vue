<template>
	<MkSpacer :contentMax="800">
		<div ref="rootEl" class="ftskorzw" style="container-type: inline-size;">
			<div class="main _gaps">
				...
				<div class="profile _gaps">
					...
					<div :key="user.id" class="main _panel">
						<div class="banner-container" :style="style">
							...
							<div class="title">
								...
								<div class="bottom">
									...
									<span v-if="user.isAdmin" style="color: var(--badge);"><i
									...
									<button v-if="!isEditingMemo && !memoDraft" class="_button add-note-button"
							...
							<div v-if="$i" class="actions">
								...
								<button v-if="$i && $i.id != user.id" class="menu _button" @click="sendMessage(user)"><i
										class="ti ti-mail"></i></button>
								<button v-if="$i && $i.id != user.id && user.host == null" class="menu _button"
									@click="sendPoints(user)"><i class="ti ti-parking"></i></button>
						...
						<div class="status">
							...
							<MkA v-if="user.isFollowing === undefined || user.ffVisibility === 'public' || (user.ffVisibility === 'followers' && user.isFollowing)"
				...
				<div class="contents _gaps">
					<div v-if="user.pinnedNotes.length > 0" class="_gaps">
						<MkNote v-for="note in user.pinnedNotes" :key="note.id" class="note _panel" :note="note"
							:pinned="true" />
					</div>
