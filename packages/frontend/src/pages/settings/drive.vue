<template>
	<div class="_gaps_m">
		...
		<FormSection>
			...
			<MkChart src="per-user-drive" :args="{ user: $i }" span="day" :limit="7 * 5" :bar="true" :stacked="true"
				:detailed="false" :aspectRatio="6" />
		</FormSection>
		...
		<FormSection>
			<div class="_gaps_m">
				...
				<FormLink to="/secure/settings/drive/cleaner">
				...
				<MkSwitch v-model="autoSensitive" @update:modelValue="saveProfile()">
					<template #label>{{ i18n.ts.enableAutoSensitive }}<span class="_beta">{{ i18n.ts.beta
							}}</span></template>
