	...
	<div class="_gaps_m">
		...
		<FormSection>
			<div class="_gaps_s">
				...
				<MkSwitch v-model="showTimelineReplies">{{ i18n.ts.flagShowTimelineReplies }}<template #caption>{{
					i18n.ts.flagShowTimelineRepliesDescription }} {{ i18n.ts.reflectMayTakeTime }}</template>
				</MkSwitch>
			</div>
		</FormSection>
		...
		<FormSection>
			...
			<div class="_gaps_m">
				<div class="_gaps_s">
					...
					<MkSwitch v-model="showGapBetweenNotesInTimeline">{{ i18n.ts.showGapBetweenNotesInTimeline }}
					</MkSwitch>
					<MkSwitch v-model="loadRawImages">{{ i18n.ts.loadRawImages }}</MkSwitch>
					<MkSwitch v-model="useReactionPickerForContextMenu">{{ i18n.ts.useReactionPickerForContextMenu }}
					</MkSwitch>
		...
		<FormSection>
			...
			<div class="_gaps_m">
				<MkRadios v-model="notificationPosition">
					...
					<option value="leftBottom"><i class="ti ti-align-box-left-bottom"></i> {{ i18n.ts.leftBottom }}
					</option>
					<option value="rightBottom"><i class="ti ti-align-box-right-bottom"></i> {{ i18n.ts.rightBottom }}
					</option>
				</MkRadios>
				...
				<MkRadios v-model="notificationStackAxis">
					...
					<option value="horizontal"><i class="ti ti-carousel-horizontal"></i> {{ i18n.ts.horizontal }}
					</option>
				</MkRadios>
			</div>
		</FormSection>
		...
		<FormSection>
			...
			<div class="_gaps_m">
				<div class="_gaps_s">
					...
					<MkSwitch v-model="disableShowingAnimatedImages">{{ i18n.ts.disableShowingAnimatedImages }}
					</MkSwitch>
		...
		<FormSection>
			...
			<div class="_gaps">
				...
				<FormLink to="/secure/settings/deck">{{ i18n.ts.deck }}</FormLink>
				<FormLink to="/secure/settings/custom-css"><template #icon><i class="ti ti-code"></i></template>{{
