...
export const DEFAULT_SERVER_ERROR_IMAGE_URL =
	"https://xn--931a.moe/assets/error.jpg";
export const DEFAULT_NOT_FOUND_IMAGE_URL =
	"https://xn--931a.moe/assets/not-found.jpg";
