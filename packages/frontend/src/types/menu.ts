...
export type MenuButton = { type?: 'button', text: string, icon?: string, indicate?: boolean, danger?: boolean, disabled?: boolean, active?: boolean, avatar?: Misskey.entities.User; action: MenuAction };
