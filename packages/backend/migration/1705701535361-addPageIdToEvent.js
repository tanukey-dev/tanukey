export class AddPageIdToEvent1705701535361 {
	...
	async up(queryRunner) {
		...
		await queryRunner.query(
			`ALTER TABLE "event_circle" RENAME COLUMN "circleImageId" TO "pageId"`,
		);
		await queryRunner.query(
			`ALTER TABLE "circle" ADD "pageId" character varying(32)`,
		);
		await queryRunner.query(
			`ALTER TABLE "event" ADD "pageId" character varying(32)`,
		);
		await queryRunner.query(
	...
	async down(queryRunner) {
		...
		await queryRunner.query(
			`ALTER TABLE "event_circle" RENAME COLUMN "pageId" TO "circleImageId"`,
		);
		await queryRunner.query(
