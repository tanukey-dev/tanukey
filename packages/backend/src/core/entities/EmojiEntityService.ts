...
export class EmojiEntityService {
	...
	public async packDetailed(
		...
		const emoji = typeof src === 'object' ? src : await this.emojisRepository.findOneByOrFail({ id: src });
		const file = emoji.driveFileId ? await this.driveFilesRepository.findOneBy({ id: emoji.driveFileId }) : await this.driveFilesRepository.findOneBy({ url: emoji.publicUrl });
