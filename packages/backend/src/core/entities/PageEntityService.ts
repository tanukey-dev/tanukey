...
export class PageEntityService {
	...
	public async pack(
		...
		return await awaitAll({
			...
			editorVersion: page.editorVersion,
			text: page.text,
			content: page.content,
			...
			isLiked: meId
				? await this.pageLikesRepository
						.findOneBy({ pageId: page.id, userId: meId })
						.then((x) => x != null)
				: undefined,
		});
	}
	...
	@bindThis
	public packMany(pages: Page[], me?: { id: User["id"] } | null | undefined) {
