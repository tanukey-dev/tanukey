...
const $admin_fullIndexStats: Provider = { provide: 'ep:admin/full-index-stats', useClass: ep___admin_fullIndexStats.default };
...
const $channels_searchByTags: Provider = { provide: 'ep:channels/search-by-tags', useClass: ep___channels_searchByTags.default };
...
const $points_send: Provider = { provide: 'ep:points/send', useClass: ep___points_send.default };
